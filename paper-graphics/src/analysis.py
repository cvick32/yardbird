...
def _benchmark_row(result: BenchmarkResult, strategy_id: str) -> dict[str, Any]:
    row = {
        ...
        "abstract_recurrent_products": result.abstract_recurrent_products,
        "synthesis_trigger": result.synthesis_trigger,
        "synthesis_guard_policy": result.synthesis_guard_policy,
        "synthesis_after": result.synthesis_after,
        "synthesis_refinement_limit_window": (result.synthesis_refinement_limit_window),
        "synthesis_repeated_pattern_threshold": (
            result.synthesis_repeated_pattern_threshold
        ),
        "depth": result.depth,

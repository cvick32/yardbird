...
echo ""
echo "  # Migrations run automatically the first time logging starts"
echo "  # as long as the binary is built with the training feature."
echo ""
...
echo "  ./target/release/yardbird --train \\"
echo "    --training-run-version quick-smoke \\"
echo "    -f examples/array/array_copy.vmt"
echo ""

...
mod concrete_distributed_protocols_depth_5 {
    ...
    snapshot_suite! {
        ...
        exclude: {
            "chord_ring_maintenance/chord_ring_maintenance.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "client_server_ae/client_server_ae.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "client_server_db_ae/client_server_db_ae.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "consensus_epr/consensus_epr.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "consensus_forall/consensus_forall.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "consensus_wo_decide/consensus_wo_decide.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "database_chain_replication/database_chain_replication.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "decentralized_lock/decentralized_lock.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "distributed_lock/distributed_lock.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "fast_paxos/fast_paxos.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "flash-coherence/flash-coherence.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "flexible_paxos/flexible_paxos.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "german/german.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "german/german_with_ghost_state.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "german/german_with_ghost_state.vmt" => "Known concrete counterexample; this suite requires bounded safety",
            "hybrid_reliable_broadcast/hybrid_reliable_broadcast.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "learning_switch_quad/learning_switch_quad.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "learning_switch_ternary/learning_switch_ternary.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "lock_server_async/lock_server_async.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "lock_server_sync/lock_server_sync.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "multi_paxos/multi_paxos.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "paxos/paxos.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "ring_leader_election/ring_leader_election.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "sharded_key_value_store/sharded_key_value_store.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "sharded_kv_no_lost_keys/sharded_kv_no_lost_keys.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "stoppable_paxos/stoppable_paxos.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "ticket_lock/ticket_lock.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "tomasulo/tomasulo.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "toy_consensus_epr/toy_consensus_epr.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "toy_consensus_forall/toy_consensus_forall.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "two_phase_commit/two_phase_commit.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
            "vertical_paxos/vertical_paxos.encoding.vmt" => "Lambda-free companion covered by corpus and encoding-equivalence tests",
        },

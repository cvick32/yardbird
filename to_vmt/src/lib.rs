...
pub use vmtil;
use yardbird::{
    cost_functions::array::array_best_symbol_cost_factory, strategies::Abstract, Driver,
};
...
pub fn run_model(
    ...
    let strat = Box::new(Abstract::new(depth, false, array_best_symbol_cost_factory));

...
#[derive(Clone, Debug)]
pub struct ArrayMinimalAstSize {
...
impl egg::CostFunction<ArrayLanguage> for ArrayMinimalAstSize {
    type Cost = u32;
...
impl YardbirdCostFunction<ArrayLanguage> for ArrayMinimalAstSize {

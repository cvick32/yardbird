...
impl ArrayCostFactory for ArrayPreferWrite {
    type Config = ();
...
impl egg::CostFunction<TermLanguage> for ArrayPreferWrite {
    type Cost = u32;
...
impl YardbirdCostFunction<TermLanguage> for ArrayPreferWrite {

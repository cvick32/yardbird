...
use context::TermCostContext;

pub trait TermCostFactory: YardbirdCostFunction<TermLanguage> + Sized {
    type Config: Clone + Send + Sync + 'static;

    fn from_context(smt: &TermCostContext, depth: u32, config: &Self::Config) -> Self;
}

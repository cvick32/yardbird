...
impl TermCostFactory for IndexAwareArrayCost {
    type Config = ();
...
impl egg::CostFunction<TermLanguage> for IndexAwareArrayCost {
    type Cost = u32;
...
impl YardbirdCostFunction<TermLanguage> for IndexAwareArrayCost {

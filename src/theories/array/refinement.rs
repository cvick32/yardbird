...
#[derive(Default)]
pub(crate) struct ArrayRefinement {
    pub(crate) array_types: Vec<(String, String)>,
    pub(crate) property_cone: PropertyCone,
    pub(crate) encoding_plan: EncodingPlan,
}
...
impl ArrayRefinement {
    ...
    pub(crate) fn candidates<F: TermCostFactory + 'static>(
        ...
        let cost_context =
            TermCostContext::from_problem(smt, &candidate_catalog, expansion.candidate_scope);

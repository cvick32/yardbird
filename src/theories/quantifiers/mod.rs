...
impl BinderRule {
    fn compile(
        ...
        phase: SearchPhase,
        types: &[(String, String)],
    ) -> Option<anyhow::Result<CompiledBinderRule<()>>> {
    ...
    fn compile_plan(
        ...
        Some((|| {
            ...
            Ok(CompiledBinderRule::input_binder(
...
impl QuantifierPlan {
    ...
    pub fn prepare(
        ...
        let cost_context = crate::policy::term_selection::context::TermCostContext::from_problem(
            smt,
            &catalog,
            crate::rule_matching::scope::CandidateScope::AllCandidates,
        );
...
struct CompiledBinderRules {
    ...
    phases: HashMap<SearchPhase, Vec<CompiledBinderRule<()>>>,
...
pub(crate) struct PreparedQuantifierSearch {
    graph_version: u64,
    additional_terms: Vec<crate::terms::language::TermExpr>,
    representatives: HashMap<egg::Id, crate::terms::language::TermExpr>,
    ...
    cursors: HashMap<SearchPhase, crate::theories::quantifiers::search::BinderSearchCursor>,
    ...
    pub cost_context: crate::policy::term_selection::context::TermCostContext,
}
...
impl PreparedQuantifierSearch {
    ...
    pub fn start_phase(&mut self, phase: SearchPhase, next_rule: usize) {
        ...
        self.cursors.insert(
            phase,
            crate::theories::quantifiers::search::BinderSearchCursor::starting_at(next_rule),
        );
    }

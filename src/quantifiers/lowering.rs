...
struct Lowerer<'a> {
    provenance: &'a mut crate::quantifiers::provenance::QuantifierProvenance,
...
impl Lowerer<'_> {
    ...
    fn binder(
        ...
        if let Some(source_id) = source_id {
            use crate::quantifiers::provenance::{LoweredQuantifier, LoweredVariable};
...
pub(crate) fn lower_model_with_provenance(
    model: VMTModel,
    provenance: &mut crate::quantifiers::provenance::QuantifierProvenance,
